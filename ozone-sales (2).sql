...
--
-- Table structure for table `sales_bid`
--

CREATE TABLE `sales_bid` (
  `bid_id` int(11) NOT NULL,
  `bid_lead_ref` varchar(50) DEFAULT NULL,
  `bid_type` varchar(50) DEFAULT NULL,
  `bid_endDate` datetime DEFAULT NULL,
  `bid_openDate` datetime DEFAULT NULL,
  `bid_validity` int(3) DEFAULT NULL,
  `bid_region` int(11) DEFAULT NULL,
  `bid_client` int(11) DEFAULT NULL,
  `bid_dept` int(11) DEFAULT NULL,
  `bid_contact_person` int(11) DEFAULT NULL,
  `bid_emd` varchar(100) DEFAULT NULL,
  `bid_emd_val` varchar(100) DEFAULT NULL,
  `bid_epbg` varchar(100) DEFAULT NULL,
  `bid_epbg_val` varchar(100) DEFAULT NULL,
  `bid_participation` int(1) DEFAULT NULL COMMENT '1= Not participated 2= participated',
  `bid_createdOn` timestamp NULL DEFAULT current_timestamp(),
  `bid_createdBy` int(11) DEFAULT NULL,
  `bid_isDelete` int(1) DEFAULT 0,
  `bid_status` int(1) DEFAULT NULL COMMENT '1=Yet to open, 2=Open, 3=In Technical Evaluation'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sales_bid`
--

INSERT INTO `sales_bid` (`bid_id`, `bid_lead_ref`, `bid_type`, `bid_endDate`, `bid_openDate`, `bid_validity`, `bid_region`, `bid_client`, `bid_dept`, `bid_contact_person`, `bid_emd`, `bid_emd_val`, `bid_epbg`, `bid_epbg_val`, `bid_participation`, `bid_createdOn`, `bid_createdBy`, `bid_isDelete`, `bid_status`) VALUES
(1, '20210606', '0', '2021-08-08 15:30:00', '2021-06-06 16:30:00', 60, 1, 1, 1, NULL, 'ssa', NULL, 'sasa', NULL, NULL, '2021-06-06 09:06:25', 3, 0, 0),
(2, 'RB20210608', 'Regular Bid', '2021-08-06 13:30:00', '2045-12-03 06:07:00', 12, 2, 14, 3, NULL, 'Yes', NULL, 'No', NULL, NULL, '2021-06-08 09:57:21', 3, 0, 0),
(3, 'PAC20210608', 'PAC', '2021-09-06 12:30:00', '1970-01-01 05:30:00', 12, 3, 1, 13, NULL, 'Yes', '12', 'No', '', NULL, '2021-06-08 10:09:21', 3, 0, 0),
(4, 'PAC20212323', 'PAC', '2021-08-06 12:30:00', '2045-12-03 06:07:00', 12, 3, 1, 4, NULL, 'No', '', 'Yes', '12', NULL, '2021-06-08 10:13:06', 3, 0, 0),
(5, 'RB/2021/0303', 'Regular Bid', '2021-06-12 11:00:00', '2021-06-09 11:00:00', 12, 1, 1, 1, NULL, 'Yes', '12', 'Yes', '12', NULL, '2021-06-09 08:30:05', 3, 0, 0),
(6, 'ss', 'RA', '2021-06-12 10:11:00', '2021-06-12 10:11:00', 12, 1, 9, 2, NULL, 'No', '', 'No', '', NULL, '2021-06-09 11:00:07', 3, 0, 0),
(7, 'GEM202112345', 'PAC', '2021-06-12 11:00:00', '2021-03-11 14:00:00', 12, 3, 1, 4, NULL, 'No', '', 'No', '', NULL, '2021-06-09 11:03:50', 3, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `sales_bid_eligibility`
--

CREATE TABLE `sales_bid_eligibility` (
  `be_id` int(11) NOT NULL,
  `be_bid_id` int(11) NOT NULL,
  `be_eligibility_id` int(11) NOT NULL,
  `be_value` longtext DEFAULT NULL,
  `be_doc_required` longtext DEFAULT NULL,
  `be_doc_name` longtext DEFAULT NULL,
  `be_doc_url` longtext DEFAULT NULL,
  `be_createdBy` int(11) NOT NULL,
  `be_createdOn` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `be_isDelete` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `sales_bid_eligibility`
--

INSERT INTO `sales_bid_eligibility` (`be_id`, `be_bid_id`, `be_eligibility_id`, `be_value`, `be_doc_required`, `be_doc_name`, `be_doc_url`, `be_createdBy`, `be_createdOn`, `be_isDelete`) VALUES
(9, 7, 1, '1', 'Yes', '', '', 3, '2021-06-09 14:18:17', 0),
(10, 7, 3, '2', 'No', '', '', 3, '2021-06-09 14:18:17', 0);

-- --------------------------------------------------------

--
-- Table structure for table `sales_bid_products`
--

CREATE TABLE `sales_bid_products` (
  `bidprod_id` int(11) NOT NULL,
  `bidprod_bid_id` int(11) NOT NULL,
  `bidprod_product_id` int(11) NOT NULL,
  `bidprod_qty` int(11) NOT NULL,
  `bidprod_spcification` longtext DEFAULT NULL,
  `bidprod_mm` longtext DEFAULT NULL,
  `bidprod_budget` float DEFAULT NULL,
  `bidprod_gem` longtext DEFAULT NULL,
  `bidprod_tprice` float DEFAULT NULL,
  `bidprod_qprice` float DEFAULT NULL,
  `bidprod_status` int(2) NOT NULL DEFAULT 0,
  `bidprod_createdOn` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `sales_bid_products`
--

INSERT INTO `sales_bid_products` (`bidprod_id`, `bidprod_bid_id`, `bidprod_product_id`, `bidprod_qty`, `bidprod_spcification`, `bidprod_mm`, `bidprod_budget`, `bidprod_gem`, `bidprod_tprice`, `bidprod_qprice`, `bidprod_status`, `bidprod_createdOn`) VALUES
(1, 1, 12, 6, '', '', 0, '', 0, 0, 0, '2021-06-06 09:06:25'),
(2, 1, 13, 7, '', '', 0, '', 0, 0, 0, '2021-06-06 09:06:25'),
(3, 2, 14, 2, '', '', 0, '', 0, 0, 0, '2021-06-08 09:57:21'),
(4, 2, 13, 2, '', '', 0, '', 0, 0, 0, '2021-06-08 09:57:21'),
(5, 3, 12, 2, '', '', 0, '', 0, 0, 0, '2021-06-08 10:09:21'),
(6, 3, 5, 2, '', '', 0, '', 0, 0, 0, '2021-06-08 10:09:21'),
(7, 4, 4, 1, '', '', 0, '', 0, 0, 0, '2021-06-08 10:13:06'),
(8, 4, 3, 2, '', '', 0, '', 0, 0, 0, '2021-06-08 10:13:06'),
(10, 6, 3, 1, '', '', 0, '', 0, 0, 0, '2021-06-09 11:00:07'),
(12, 5, 11, 2, 'spec', 'MM', 1000010, 'gemlink', 12, 12, 0, '2021-06-09 11:49:00'),
(13, 5, 13, 3, '', '', 0, '', 0, 0, 0, '2021-06-09 11:49:00'),
(97, 7, 12, 12, 'spec', 'mm', 123022, 'gem', 12, 12, 0, '2021-06-09 14:18:17'),
(98, 7, 11, 10, 'spec', 'mm', 123022, 'gem', 21, 21, 0, '2021-06-09 14:18:17');

-- --------------------------------------------------------

--
-- Table structure for table `sales_bid_terms`
--

CREATE TABLE `sales_bid_terms` (
  `bt_id` int(11) NOT NULL,
  `bt_bid_id` int(11) NOT NULL,
  `bt_term_id` int(11) NOT NULL,
  `bt_value` longtext DEFAULT NULL,
  `bt_doc_required` longtext DEFAULT NULL,
  `bt_doc_remark` longtext DEFAULT NULL,
  `bt_doc_url` longtext DEFAULT NULL,
  `bt_createdBy` int(11) NOT NULL,
  `bt_createdOn` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `bt_isDelete` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `sales_bid_terms`
--

INSERT INTO `sales_bid_terms` (`bt_id`, `bt_bid_id`, `bt_term_id`, `bt_value`, `bt_doc_required`, `bt_doc_remark`, `bt_doc_url`, `bt_createdBy`, `bt_createdOn`, `bt_isDelete`) VALUES
(3, 7, 2, '1', 'Yes', 'sa', NULL, 3, '2021-06-09 14:18:17', 0),
(4, 7, 4, '3', 'Yes', 'sa', NULL, 3, '2021-06-09 14:18:17', 0);

-- --------------------------------------------------------

--
-- Table structure for table `sales_bid_type`
--

CREATE TABLE `sales_bid_type` (
  `btype_id` int(11) NOT NULL,
  `btype_name` varchar(50) NOT NULL,
  `btype_isDelete` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `sales_bid_type`
--

INSERT INTO `sales_bid_type` (`btype_id`, `btype_name`, `btype_isDelete`) VALUES
(1, 'RA', 0),
(2, 'PAC', 0),
(3, 'Regular Bid', 0);
...
INSERT INTO `sales_cities` (`ct_id`, `ct_name`, `st_id`) VALUES
(1, 'BOMBUFLAT', 1),
(2, 'GARACHARMA', 1),
(3, 'PORT BLAIR', 1),
(4, 'RANGAT', 1),
...
CREATE TABLE `sales_client` (
  ...
  `client_other_contact` varchar(15) DEFAULT NULL,
  `client_email` varchar(50) DEFAULT NULL,
  `client_other_email` varchar(50) DEFAULT NULL,
  `client_address` varchar(500) DEFAULT NULL,
  `client_state` int(11) DEFAULT NULL,
  `client_city` int(11) DEFAULT NULL,
  `client_pincode` varchar(8) DEFAULT NULL,
  `client_website` varchar(100) DEFAULT NULL,
  `client_isDelete` int(2) DEFAULT 0,
  `client_createdBy` int(11) NOT NULL,
  `client_createdOn` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `sales_client` (`client_id`, `client_name`, `client_contact`, `client_other_contact`, `client_email`, `client_other_email`, `client_address`, `client_state`, `client_city`, `client_pincode`, `client_website`, `client_isDelete`, `client_createdBy`, `client_createdOn`) VALUES
(1, 'Central Public Works Department', '98744563210', '9123654789', 'test2233@gmail.com', 'test2@gmail.com', '', 22, 2489, '', 'nimble-esolutions.com', 0, 1, '2021-05-05 06:09:28'),
(7, 't n yyy', '9874456321', '35353354', 'test2@gmail.com', 'test2@gmail.com', 'dfdsfdsf fsdfsef', 22, 2489, NULL, '', 1, 3, '2021-06-04 13:39:04'),
(8, 't n yyy', '9874456321', '35353354', 'test2@gmail.com', 'test2@gmail.com', 'dfdsfdsf fsdfsef', 22, 2489, NULL, '', 1, 3, '2021-06-04 13:39:09'),
(9, 'nimble e solutions', '8238746591', '9874563210', 'nimbleesolutions123@gmail.com', 'info@nimble-esolutions.com', 'mayur colony kothrud pune', 22, 2763, '411038', 'nimble-esolutions.com', 0, 3, '2021-05-03 19:29:05'),
(10, 't n yyy', '9874456321', '35353354', 'test2@gmail.com', 'test2@gmail.com', 'dfdsfdsf fsdfsef', 22, 2489, '411085', '', 1, 3, '2021-06-04 13:39:15'),
(11, 't n yyyfreretr  ', '8238746591', '', 'test2@gmail.com', 'test2@gmail.com', 'dfdsfdsf fsdfsef', 14, 0, '411085', '', 1, 3, '2021-06-04 13:39:19'),
(12, 'kunjika', '8238746591', '9874563210', 'test2@gmail.com', 'test2@gmail.com', '', 2, 2480, '', 'nimble-esolutions.com', 0, 3, '2021-05-06 11:24:42'),
(13, 'HRCT Pvt Ltd.', '9878676777', '1234567890', 'info@hrct.com', 'other@hrct.com', 'Shikrapur MIDC																																	', 20, 2067, '412406', 'http://hrct.com', 1, 0, '2021-06-04 13:39:35'),
(14, 'HRCT Pvt Ltd.', '9878676777', '', 'info@hrct.comm', '', '																																				Shikrapur MIDC																																												', 22, 2763, '412406', 'http://hrct.com', 0, 0, '2021-06-04 12:56:38');

-- --------------------------------------------------------

--
-- Table structure for table `sales_contact_person`
--

CREATE TABLE `sales_contact_person` (
  `cp_id` int(11) NOT NULL,
  `cp_first_name` varchar(100) NOT NULL,
  `cp_middle_name` varchar(100) DEFAULT NULL,
  `cp_last_name` varchar(100) DEFAULT NULL,
  `cp_mobile` varchar(15) NOT NULL,
  `cp_other_contact` varchar(15) DEFAULT NULL,
  `cp_email` varchar(50) NOT NULL,
  `cp_other_email` varchar(50) DEFAULT NULL,
  `cp_department` int(11) NOT NULL,
  `cp_company` int(11) NOT NULL,
  `cp_contact_for` int(2) DEFAULT NULL COMMENT '1=client 2=vendor',
  `cp_isDelete` int(2) DEFAULT 0,
  `cp_createdBy` int(11) DEFAULT NULL,
  `cp_createdOn` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sales_contact_person`
--

INSERT INTO `sales_contact_person` (`cp_id`, `cp_first_name`, `cp_middle_name`, `cp_last_name`, `cp_mobile`, `cp_other_contact`, `cp_email`, `cp_other_email`, `cp_department`, `cp_company`, `cp_contact_for`, `cp_isDelete`, `cp_createdBy`, `cp_createdOn`) VALUES
(1, 'Arvind', 'Sadashiv', 'Gokhale', '9874563210', '1236987450', 'arvind.gokhale@gmail.com', '', 1, 1, 1, 0, 1, '2021-04-02 07:45:08'),
(2, 'Meenal', 'T', 'Date', '9874563210', '1236987450', 'date.m@gmail.com', '', 2, 1, 1, 0, 1, '2021-04-02 10:08:27'),
(3, 't', 'n', 'yyy', '2837283723', '5453535353', 'test2@gmail.com', '', 1, 8, 1, 0, 3, '2021-05-03 01:08:01'),
(4, 'Neeta', 'Umesh', 'Joshi', '98745123654', '', 'neetaj16@gmail.com', '', 1, 9, 1, 0, 3, '2021-05-03 19:29:05'),
(5, 'Sagar', '', 'HRCT', '908765', '', 'sagar@hrct.com', NULL, 3, 14, NULL, 0, NULL, '2021-06-04 10:11:01');

-- --------------------------------------------------------

--
-- Table structure for table `sales_country_code`
--

CREATE TABLE `sales_country_code` (
  `id` int(11) NOT NULL,
  `iso` char(2) NOT NULL,
...
--
-- Dumping data for table `sales_country_code`
--

INSERT INTO `sales_country_code` (`id`, `iso`, `name`, `nicename`, `iso3`, `numcode`, `phonecode`) VALUES
...
INSERT INTO `sales_department` (`dept_id`, `dept_name`, `dept_isDelete`) VALUES
(1, 'Data Center', 0),
(2, 'Purchase', 0),
(3, 'Sales', 0),
(4, 'Human Resource', 0),
...
--
-- Table structure for table `sales_eligibility`
--

CREATE TABLE `sales_eligibility` (
  `el_id` int(11) NOT NULL,
  `el_name` longtext NOT NULL,
  `el_isDelete` int(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sales_eligibility`
--

INSERT INTO `sales_eligibility` (`el_id`, `el_name`, `el_isDelete`) VALUES
(1, 'Minimum Average Annual Turnover of the Bidder', 0),
(2, 'OEM Average Turnover [Last 3 years]', 0),
(3, 'Years of Past Experience required', 0),
(4, 'MSE Exemption for Turnover', 0);
...
CREATE TABLE `sales_lead` (
  ...
  `lead_generated_date` date DEFAULT NULL,
  `lead_client` int(11) DEFAULT NULL,
  `lead_dept` int(11) DEFAULT NULL,
  `lead_contact_person` int(11) DEFAULT NULL,
  `lead_due_date` date DEFAULT NULL,
  `lead_budget` float DEFAULT NULL,
  `lead_region` int(11) DEFAULT NULL,
  `lead_procurement_type` int(2) DEFAULT 0 COMMENT '0=bid 1=tender 2=quotation',
  `lead_file_status` int(2) DEFAULT 0,
  `lead_status` int(2) DEFAULT NULL COMMENT '0=in progress 1=converted into bid 3=hold ',
  `lead_participation_status` int(2) DEFAULT NULL COMMENT '0=yes 1=no',
  `lead_participation_remark` longtext DEFAULT NULL,
  `lead_isDelete` int(1) DEFAULT 0,
  `lead_createdBy` int(11) DEFAULT NULL,
  `lead_createdOn` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `sales_lead` (`lead_id`, `lead_generated_date`, `lead_client`, `lead_dept`, `lead_contact_person`, `lead_due_date`, `lead_budget`, `lead_region`, `lead_procurement_type`, `lead_file_status`, `lead_status`, `lead_participation_status`, `lead_participation_remark`, `lead_isDelete`, `lead_createdBy`, `lead_createdOn`) VALUES
(1, '2021-04-15', 1, 2, 2, '2021-04-30', 900000, NULL, 0, 0, 0, 0, '', 0, 3, '2021-04-02 00:06:32'),
(2, '2021-04-01', 1, 1, 1, '2021-04-30', 900000, NULL, 0, 0, 0, 0, '', 0, 3, '2021-04-02 01:14:57'),
(3, '2021-04-30', 1, 1, 1, '2021-08-21', 900000, NULL, 0, 0, 0, 0, '', 0, 3, '2021-04-28 20:12:27'),
(4, '2021-04-30', 1, 1, 1, '2021-08-21', 900000, NULL, 0, 0, 0, 0, '', 0, 3, '2021-04-28 20:12:45'),
(5, '2021-04-30', 1, 1, NULL, '2021-08-21', 900000, NULL, 0, 0, 0, 0, '', 0, 3, '2021-04-30 00:07:22'),
(6, '2021-05-11', 1, 2, NULL, '2021-05-29', 900000, NULL, 0, 0, 0, 0, '', 0, 3, '2021-05-03 00:30:57'),
(7, '2021-05-04', 9, 1, NULL, '2021-05-31', 90000, NULL, 0, 0, 0, 0, '', 0, 3, '2021-05-03 19:29:45'),
(8, '2021-04-16', 9, 1, NULL, '2021-05-31', 0, 1, 0, 0, 0, 0, '', 0, 3, '2021-05-20 01:48:08');

-- --------------------------------------------------------

--
-- Table structure for table `sales_lead_data_call`
--

CREATE TABLE `sales_lead_data_call` (
  `dc_id` int(11) NOT NULL,
  `dc_lead_id` int(11) NOT NULL,
  `dc_date` date DEFAULT NULL,
  `dc_action` varchar(50) DEFAULT NULL,
  `dc_remark` longtext DEFAULT NULL,
  `dc_isDelete` int(11) NOT NULL,
  `dc_createdBy` int(11) NOT NULL,
  `dc_createdOn` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `sales_lead_data_call`
--

INSERT INTO `sales_lead_data_call` (`dc_id`, `dc_lead_id`, `dc_date`, `dc_action`, `dc_remark`, `dc_isDelete`, `dc_createdBy`, `dc_createdOn`) VALUES
(2, 8, '2021-05-28', 'Call', 'Visit For Datacasll', 0, 3, '2021-05-28 05:10:41');

-- --------------------------------------------------------

--
-- Table structure for table `sales_lead_requirement`
--

CREATE TABLE `sales_lead_requirement` (
  `lr_id` int(11) NOT NULL,
  `lr_lead_id` int(11) NOT NULL,
  `lr_product_id` int(11) NOT NULL,
  `lr_quantity` int(4) DEFAULT NULL,
  `lr_proposed_product` longtext DEFAULT NULL,
  `lr_product_specification` longtext DEFAULT NULL,
  `lr_product_gem_link` varchar(500) DEFAULT NULL,
  `lr_isDelete` int(2) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sales_lead_requirement`
--

INSERT INTO `sales_lead_requirement` (`lr_id`, `lr_lead_id`, `lr_product_id`, `lr_quantity`, `lr_proposed_product`, `lr_product_specification`, `lr_product_gem_link`, `lr_isDelete`) VALUES
(1, 4, 1, 12, '', '', '', 0),
(2, 4, 2, 10, '', '', '', 0),
(3, 5, 1, 120454545, '', '', '', 0),
(4, 5, 2, 11111111, '', '', '', 0),
...
(11, 7, 2, 5, '', '', '', 0),
(12, 1, 1, 45, '', '', '', 0),
(13, 8, 1, 120, 'vjvhjdgh difieun', 'bhjbhjb', '', 0);
...
CREATE TABLE `sales_product` (
  ...
  `product_isDelete` int(2) DEFAULT 0,
...
INSERT INTO `sales_product` (`product_id`, `product_name`, `product_isDelete`, `product_cat`) VALUES
(1, 'Desktop Computer', 0, 1),
(2, 'Tablet Computer', 0, 1),
(3, 'All in One -PC', 0, 1),
(4, 'Think Center', 0, 1),
(5, 'Laptop Notebook', 0, 1),
(6, 'Computer Printer', 0, 1),
(7, 'MFM-Multifunction Machine', 0, 1),
(8, 'Scanner', 0, 1),
(9, 'Line interactive UPS (offline)', 0, 1),
(10, 'Online UPS', 0, 1),
(11, 'Antivirus', 0, 1),
(12, 'Microsoft Office', 0, 1),
(13, 'Biometric Machine', 0, 1),
(14, 'Computer- Server', 0, 1),
(15, 'Computer - Workstation', 0, 1),
(16, 'Plotter -Printer', 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `sales_region`
--

CREATE TABLE `sales_region` (
  `reg_id` int(11) NOT NULL,
  `reg_name` varchar(200) DEFAULT NULL,
  `reg_isDelete` int(1) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sales_region`
--

INSERT INTO `sales_region` (`reg_id`, `reg_name`, `reg_isDelete`) VALUES
(1, 'Pune', 0),
(2, 'Goa', 0),
(3, 'Navi Mumbai', 0),
(4, 'Nagpur', 0);
...
INSERT INTO `sales_state` (`st_id`, `st_name`, `country_id`) VALUES
...
--
-- Table structure for table `sales_terms`
--

CREATE TABLE `sales_terms` (
  `term_id` int(11) NOT NULL,
  `term_name` longtext NOT NULL,
  `term_isDelete` int(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sales_terms`
--

INSERT INTO `sales_terms` (`term_id`, `term_name`, `term_isDelete`) VALUES
(1, 'Bidder financial standing', 0),
(2, 'Data Sheet', 0),
(3, 'v', 0),
(4, 'Experience criteria', 0);
...
INSERT INTO `sales_user` (`user_id`, `user_firstName`, `user_middleName`, `user_lastName`, `user_mobile`, `user_email`, `user_adhar_card`, `user_pan_card`, `user_passport`, `user_password`, `user_role_id`, `user_vendor_id`, `user_isDelete`, `user_createdOn`, `user_createdBy`) VALUES
...
(2, 'Amit', NULL, 'Ozone', '2024264520', 'amit@ozoneinfo.in', NULL, NULL, NULL, '$2y$10$5luKYLh0JXnN1QLRWX6GH.GHb4xMnLopRB0XLXY.49kO/YBBnVlAq', 2, 0, 0, '2021-03-23 21:36:59', 1),
(3, 'Sales', NULL, 'Ozone', '2024264520', 'sales@ozoneinfo.in', NULL, NULL, NULL, '$2y$10$oyCDr1Rco28NzXvV1/6yeuykH3DAy06ZCJK58TBZVyH7MCmwZvB2G', 3, 0, 0, '2021-03-23 21:48:21', 1),
(4, 'Bid ', NULL, 'Ozone', '1234567890', 'bid@ozoneinfo.in', NULL, NULL, NULL, '$2y$10$j4fw29Jty5mrHItw7plOZerGh6lI8Hwdbis64YlBF8hj0kFbWSngq', 4, 0, 0, '2021-06-07 11:03:01', 1);

-- --------------------------------------------------------

--
-- Table structure for table `sales_user_role`
--
...
--
-- Dumping data for table `sales_user_role`
--

INSERT INTO `sales_user_role` (`role_id`, `role_name`, `role_isValid`) VALUES
(1, 'Super Admin', 0),
(2, 'Admin', 0),
(3, 'Sales Executive', 0),
(4, 'Bid Executive', 0);
...
--
-- Table structure for table `sales_user_session`
--

CREATE TABLE `sales_user_session` (
  `id` int(20) NOT NULL,
...
--
-- Indexes for table `sales_bid`
--
ALTER TABLE `sales_bid`
  ADD PRIMARY KEY (`bid_id`);

--
-- Indexes for table `sales_bid_eligibility`
--
ALTER TABLE `sales_bid_eligibility`
  ADD PRIMARY KEY (`be_id`);

--
-- Indexes for table `sales_bid_products`
--
ALTER TABLE `sales_bid_products`
  ADD PRIMARY KEY (`bidprod_id`);

--
-- Indexes for table `sales_bid_terms`
--
ALTER TABLE `sales_bid_terms`
  ADD PRIMARY KEY (`bt_id`);

--
-- Indexes for table `sales_bid_type`
--
ALTER TABLE `sales_bid_type`
  ADD PRIMARY KEY (`btype_id`);

--
-- Indexes for table `sales_client`
--
ALTER TABLE `sales_client`
  ADD PRIMARY KEY (`client_id`);

--
-- Indexes for table `sales_contact_person`
--
ALTER TABLE `sales_contact_person`
  ADD PRIMARY KEY (`cp_id`);

--
-- Indexes for table `sales_country_code`
--
ALTER TABLE `sales_country_code`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `sales_eligibility`
--
ALTER TABLE `sales_eligibility`
  ADD PRIMARY KEY (`el_id`);

--
-- Indexes for table `sales_lead`
--
ALTER TABLE `sales_lead`
  ADD PRIMARY KEY (`lead_id`);

--
-- Indexes for table `sales_lead_data_call`
--
ALTER TABLE `sales_lead_data_call`
  ADD PRIMARY KEY (`dc_id`);

--
-- Indexes for table `sales_lead_requirement`
--
ALTER TABLE `sales_lead_requirement`
...
--
-- Indexes for table `sales_region`
--
ALTER TABLE `sales_region`
  ADD PRIMARY KEY (`reg_id`);

--
-- Indexes for table `sales_terms`
--
...
--
-- Indexes for table `sales_user_role`
--
ALTER TABLE `sales_user_role`
  ADD PRIMARY KEY (`role_id`);

--
-- Indexes for table `sales_user_session`
--
ALTER TABLE `sales_user_session`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `sales_bid`
--
ALTER TABLE `sales_bid`
  MODIFY `bid_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `sales_bid_eligibility`
--
ALTER TABLE `sales_bid_eligibility`
  MODIFY `be_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `sales_bid_products`
--
ALTER TABLE `sales_bid_products`
  MODIFY `bidprod_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT for table `sales_bid_terms`
--
ALTER TABLE `sales_bid_terms`
  MODIFY `bt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `sales_bid_type`
--
ALTER TABLE `sales_bid_type`
  MODIFY `btype_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `sales_client`
--
ALTER TABLE `sales_client`
  MODIFY `client_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `sales_contact_person`
--
ALTER TABLE `sales_contact_person`
  MODIFY `cp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `sales_country_code`
--
ALTER TABLE `sales_country_code`
...
--
-- AUTO_INCREMENT for table `sales_eligibility`
--
ALTER TABLE `sales_eligibility`
  MODIFY `el_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `sales_lead`
--
ALTER TABLE `sales_lead`
  MODIFY `lead_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `sales_lead_data_call`
--
ALTER TABLE `sales_lead_data_call`
  MODIFY `dc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `sales_lead_requirement`
--
ALTER TABLE `sales_lead_requirement`
  MODIFY `lr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- AUTO_INCREMENT for table `sales_region`
--
ALTER TABLE `sales_region`
  MODIFY `reg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `sales_terms`
--
ALTER TABLE `sales_terms`
...
--
-- AUTO_INCREMENT for table `sales_user_role`
--
ALTER TABLE `sales_user_role`
  MODIFY `role_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `sales_user_session`
--
ALTER TABLE `sales_user_session`
