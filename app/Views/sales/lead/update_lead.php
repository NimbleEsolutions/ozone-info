			                            ...
			                            $k=0;
		                            		...
		                            		<tr>
			                                    ...
			                                    <td id="lr_proposed_product"><input type="text" class="form-control lr_proposed_product" name="lr_proposed_product[<?php echo $k;?>]" value="<?php echo  $pkey['lr_proposed_product'];?>"></td>
			                                      <td id="lr_product_specification"><textarea class="form-control lr_product_specification" name="lr_product_specification[<?php echo $k;?>"><?php echo  $pkey['lr_product_specification'];?></textarea>
			                                    ...
			                                    <td id="lr_oem_involved">
			                                    	<select class="form-control" name="lr_oem_involved">
			                                    		<option>Please select</option>
