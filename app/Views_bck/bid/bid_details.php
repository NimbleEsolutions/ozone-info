                ...
                <tbody>   
                  ...
                  ?>
                    <tr>
                      ...
                      <td style="text-align: center;"><?php if($bkey['bid_status'] == 0) { echo "In Progress";} ?></td>
                      <td style="text-align: center;"></td>
                      <td style="text-align: center;">
                        <a href="<?= site_url("bid/".$bkey['bid_id']."/update_details") ?>"><span class="btn btn-primary btn-sm"><i class="fa fa-pencil-alt fa-sm" title="Edit Bid"></i></span></a>
